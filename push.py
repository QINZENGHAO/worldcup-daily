...
data_text = "\n".join(all_data) if all_data else "No data available today"
print("Data:\n" + data_text[:500])

msg = "You are a professional football analyst. Date: " + date_str + "\n\n"
msg += "Match data:\n" + data_text + "\n\n"
msg += "Generate a complete HTML dashboard for today matches.\n"
msg += "Include for each match: win probabilities, Asian handicap analysis, over/under analysis, recommended scores (3 options), upset risk.\n"
msg += "Style: dark theme #080B0F background, #F0B429 gold, responsive, no external dependencies.\n"
